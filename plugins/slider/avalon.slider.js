 ...
 */
define(["../plugins/draggable/avalon.draggable", "text!./avalon.slider.html", "css!../plugins/chameleon/oniui-common.css", "css!./avalon.slider.css", "../avalon.getModel"], function(avalon, sourceHTML) {
    /**
    ...
    widget.defaults = {
        ...
        min: 0, //@config 组件的最小值
        width: -1,
        orientation: "vertical", //@config 组件是水平拖动还是垂直拖动，垂直是“vertical”
        /**
