 ...
 * @introduce
 */
define(["avalon", "text!./avalon.layout.html", "css!./avalon.layout.css", "../menupanel/avalon.menupanel.js"], function(avalon, template) {
    /**
        ...
        var vm = avalon.mix({
            ...
            split: function () {
                ...
                for(var i = 0; i < totalSpan-1; i++){
                    vmodel.rows[rowIndex]['cols'].splice(temp, 0, {colspan:1, name:'ddf'});
                }
